	...
	public static void main(String[] args) {
			...
			while (true) {
				...
				case 8:
					...
					break;
				case 9:
					System.out.println(Cores.TEXT_WHITE_BOLD + "Consulta por nome do titular\n\n");
		...
		if(conta.isPresent()) {
			...
			switch(tipo) {
				...
				case 2 -> {
					...
					int aniversario = contaPoupanca.getDia_aniversario();
					
					// Atualiza o aniversário ou mantém o valor atual
					System.out.printf("Dia do aniversário atual: %d"
								+ "%nDigite o novo dia do aniversário da conta (Pressione ENTER para manter o valor atual)", aniversario);
					entrada = leia.nextLine();
